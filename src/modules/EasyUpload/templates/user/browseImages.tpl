...
{pagesetvar name='title' value=$templatetitle}
    ...
    <p><i>{gt text="Click to an image to include it!"}</i></p>

    {foreach from=$images item="image"}
        <a href="javascript:returnUrl('{$modvars.EasyUpload.uploads_path}/{$image}')"><img src="{$baseUrl}{$modvars.EasyUpload.uploads_path}/thumbs/{$image}.jpg"></a>
    {foreachelse}
